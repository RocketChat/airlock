...
test: manifests generate fmt vet envtest ## Run tests.
	KUBEBUILDER_ASSETS="$(shell $(ENVTEST) use $(ENVTEST_K8S_VERSION) --bin-dir $(LOCALBIN) -p path)" go test ./tests/ -v -ginkgo.v -coverprofile cover.out

##@ Build

.PHONY: build
build: generate fmt vet test ## Build manager binary.
